...
2. 编译开发板：从仓库的release页面，https://github.com/maidang-xing/arduino-TuyaOpen/releases/download/globel/package_tuya_open_index.json  下载开发板包，并在arduino-cli中添加开发板管理器URL。
